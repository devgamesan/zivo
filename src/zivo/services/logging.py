...
_HANDLER_NAME = "zivo-file-handler"
_ACTIVE_LOGGER_NAME = "zivo"
...
def resolve_default_log_path(config_path: str) -> Path:
    ...
    if config_path.strip():
        return Path(config_path).expanduser().parent / "zivo.log"
    return resolve_config_path().parent / "zivo.log"
